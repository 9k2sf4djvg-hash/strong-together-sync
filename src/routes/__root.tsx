...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Strong Together — ניהול אימונים" },
      {
        name: "description",
        content: "אפליקציית ניהול אימונים למאמנים ומתאמנים: בלוקים, תרגילים, סטים ומעקב RPE.",
      },
      { name: "theme-color", content: "#10b981" },
      { property: "og:title", content: "Strong Together — ניהול אימונים" },
      {
        property: "og:description",
        content: "בניית בלוקי אימונים ומעקב ביצוע בעברית, בכל מכשיר.",
      },
